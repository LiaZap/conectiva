const STYLES = {
  ...
  aguardando_avaliacao: 'bg-yellow-500/15 text-yellow-400 border border-yellow-500/30',
  // canais
...
const LABELS = {
  ...
  expirada: 'Expirada',
  aguardando_avaliacao: 'Avaliando',
  whatsapp: 'WhatsApp',
  site: 'Site',
  critica: 'Crítica',
  alta: 'Alta',
...
const DOT_COLORS = {
  ...
  aguardando_avaliacao: 'bg-yellow-400 animate-pulse',
};
